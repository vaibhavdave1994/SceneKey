...
import com.scenekey.activity.TagsOtherActivity;
...
public class Tags_other_Adapter extends RecyclerView.Adapter<Tags_other_Adapter.ViewHolder> {
    private ArrayList<TagModal> tagList;
    private Context context;
    String catId = "";
    String category_name = "";
    TagsOtherActivity activity;
    FollowUnfollowLIstner followUnfollowLIstner;
    boolean fromProfile = false;

    @TargetApi(Build.VERSION_CODES.KITKAT)
    public Tags_other_Adapter(boolean fromProfile, Context context, ArrayList<TagModal> tagList, String catId, String category_name,
                              FollowUnfollowLIstner followUnfollowLIstner) {
        this.tagList = tagList;
        this.context = context;
        activity = (TagsOtherActivity) context;
        this.catId = catId;
    ...
    @NonNull
    @Override
    public Tags_other_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.tags_views_layout, parent, false);
        return new Tags_other_Adapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final Tags_other_Adapter.ViewHolder holder, final int position) {
