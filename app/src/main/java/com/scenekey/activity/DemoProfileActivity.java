...
import com.scenekey.demoViewPgr.DemoHorizontalViewPAger;
...
public class DemoProfileActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private BottomSheetBehavior<android.view.View> mBottomSheetBehavior;
    ...
    private DemoHorizontalViewPAger demoHorizontalViewPAger;
    ...
    private void inItView() {
        ...
        if (getIntent().getSerializableExtra("fromRoomAdapter") != null) {
            cardArrayList = (ArrayList<Card>) getIntent().getSerializableExtra("fromRoomAdapter");
            int pos = getIntent().getIntExtra("fromRoomAdapterPostion", 0);
            ...
            if (card.name.equalsIgnoreCase(userInfo.userName)) {
                ...
                tvHomeTitle.setText(userInfo.userName);
            ...
            demoHorizontalViewPAger = new DemoHorizontalViewPAger(getSupportFragmentManager());
        ...
        if (utility.checkInternetConnection()) {
            StringRequest request = new StringRequest(Request.Method.POST, WebServices.SET_STATUS, new Response.Listener<String>() {
                ...
                public void onErrorResponse(VolleyError e) {
                    ...
                    dismissProgDialog();
                    Utility.showToast(DemoProfileActivity.this, getResources().getString(R.string.somethingwentwrong), 0);
                }
            }) {
                @Override
            ...
            Utility.showToast(DemoProfileActivity.this, getResources().getString(R.string.internetConnectivityError), 0);
            dismissProgDialog();
        }
    }
                ...
                public void onResponse(String Response) {
                    ...
                    try {
                        ...
                        if (statusCode == 1) {
                            ...
                            Utility.showToast(DemoProfileActivity.this, message, 0);
                            Log.e("step14", "Pass");
                        }
    ...
    public UserInfo userInfo() {
        if (userInfo == null) {
            if (!SceneKey.sessionManager.isLoggedIn()) {
                SceneKey.sessionManager.logout(DemoProfileActivity.this);
            }
            userInfo = SceneKey.sessionManager.getUserInfo();
        }
        return userInfo;
