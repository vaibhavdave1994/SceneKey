...
public class SummeryModelCopy implements Serializable {
    ...
    public static class EventBean {
        ...
        @SerializedName("venue_hour")
        private List<VenueHourBean> venue_hour = new ArrayList<>();
        @SerializedName("feedPost")
        private List<FeedPostBean> feedPost = new ArrayList<>();
        @SerializedName("keyInUser")
        private List<KeyInUserBean> keyInUser = new ArrayList<>();
