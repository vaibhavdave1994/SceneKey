...
public class LiveKeyInProfileActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void showKeyInUI(int pos) {
        ...
        downloadFileFromS3(keyInUserModal, (credentialsProvider == null ? credentialsProvider = getCredentials() : credentialsProvider));

        horizontalKeyInViewPagerAdapter = new HorizontalKeyInViewPagerAdapter(getSupportFragmentManager());
        horizontalKeyInViewPagerAdapter.setUserList(keyInUserModalArrayList);
        viewPager.setAdapter(horizontalKeyInViewPagerAdapter);
                ...
                public void onResponse(String Response) {
                    ...
                    try {
                        ...
                        if (statusCode == 1) {
                            ...
                            Utility.showToast(LiveKeyInProfileActivity.this, message, 0);
                            Log.e("step14", "Pass");
                        }
        ...
        if (utility.checkInternetConnection()) {
            StringRequest request = new StringRequest(Request.Method.POST, WebServices.SET_STATUS, new Response.Listener<String>() {
                ...
                public void onErrorResponse(VolleyError e) {
                    utility.volleyErrorListner(e);
                    dismissProgDialog();
                    Utility.showToast(LiveKeyInProfileActivity.this, getResources().getString(R.string.somethingwentwrong), 0);
                }
            }) {
                @Override
                public Map<String, String> getParams() {
            ...
            Utility.showToast(LiveKeyInProfileActivity.this, getResources().getString(R.string.internetConnectivityError), 0);
            dismissProgDialog();
        }
    }
    ...
    private void sendNudgeApi(final KeyInUserModal keyInUserModal) {
        ...
        if (utility.checkInternetConnection()) {
            ...
            StringRequest request = new StringRequest(Request.Method.POST, WebServices.ADD_NUDGE, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        if (status.equals("1")) {
                            ...
                            Toast.makeText(LiveKeyInProfileActivity.this, message, Toast.LENGTH_SHORT).show();
                            dismissProgDialog();
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                ...
                public void onErrorResponse(VolleyError e) {
                    utility.volleyErrorListner(e);
                    dismissProgDialog();
                    Utility.showToast(LiveKeyInProfileActivity.this, getString(R.string.somethingwentwrong), 0);
                }
            }) {
                @Override
                public Map<String, String> getParams() {
                    ...
                    params.put("nudges_to", keyInUserModal.userid);
                    params.put("nudges_by", userInfo.userid);
                    params.put("facebook_id", keyInUserModal.userFacebookId);
    ...
    private void downloadFileFromS3(final KeyInUserModal keyInUserModal, CognitoCredentialsProvider credentialsProvider) {//, CognitoCachingCredentialsProvider credentialsProvider){
        try {
            ...
            Thread thread = new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        if (!keyInUserModal.userFacebookId.isEmpty()) {
                            listing = s3Client.listObjects(Constant.BUCKET, Constant.DEV_TAG + keyInUserModal.userFacebookId);
                        } else {
                            listing = s3Client.listObjects(Constant.BUCKET, Constant.DEV_TAG + keyInUserModal.userid);
                        }
