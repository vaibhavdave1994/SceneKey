...
public class BoardBottomSheetDialog extends BottomSheetDialogFragment {
    private BoardSheetListener mListener;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.dialog_board, container, false);
    ...
    public void onAttach(Context context) {
        ...
        try {
            mListener = (BoardSheetListener) context;
    ...
    public interface BoardSheetListener {
