...
public class ArcMenu extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        mArcLayout =  findViewById(R.id.arcmenu_item_layout);

        layMenu =  findViewById(R.id.layArcMenu);
        mIcon =  findViewById(R.id.imgPlusIcon);
        fabMenu =  findViewById(R.id.fabArcMenu);
        ...
        switch (gravity) {
            case BOTTOM_LEFT:
                setArcLayoutParam(ANIM_BOTTOM_TO_DOWN,
                        Gravity.BOTTOM | Gravity.START, mFromDegree = 265, mToDegree = 365);
                setMenuParam(mMenuMargin, 0, 0, mMenuMargin, Gravity.BOTTOM | Gravity.START);
                break;
            case BOTTOM_MIDDLE:
                setArcLayoutParam(ANIM_BOTTOM_TO_DOWN,
            ...
            case BOTTOM_RIGHT:
                setArcLayoutParam(ANIM_BOTTOM_TO_DOWN,
                        Gravity.END | Gravity.BOTTOM, mFromDegree = 275, mToDegree = 175);
                setMenuParam(0, 0, mMenuMargin, mMenuMargin, Gravity.END | Gravity.BOTTOM);
                break;
            case LEFT_MIDDLE:
                setArcLayoutParam(ANIM_MIDDLE_TO_DOWN,
                        Gravity.START | Gravity.CENTER_VERTICAL, mFromDegree = -95, mToDegree = 95);
                setMenuParam(mMenuMargin, 0, 0, 0, Gravity.START | Gravity.CENTER_VERTICAL);
                break;
            case RIGHT_MIDDLE:
                setArcLayoutParam(ANIM_MIDDLE_TO_DOWN,
                        Gravity.END | Gravity.CENTER_VERTICAL, mFromDegree = 275, mToDegree = 85);
                setMenuParam(0, 0, mMenuMargin, 0, Gravity.END | Gravity.CENTER_VERTICAL);
                break;
            case TOP_LEFT:
                setArcLayoutParam(ANIM_TOP_TO_UP,
                        Gravity.START | Gravity.TOP, mFromDegree = -5, mToDegree = 95);
                setMenuParam(mMenuMargin, mMenuMargin, 0, 0, Gravity.START | Gravity.TOP);
                break;
            case TOP_MIDDLE:
                setArcLayoutParam(ANIM_TOP_TO_UP,
            ...
            case TOP_RIGHT:
                setArcLayoutParam(ANIM_TOP_TO_UP,
                        Gravity.END | Gravity.TOP, mFromDegree = 85, mToDegree = 185);
                setMenuParam(0, mMenuMargin, mMenuMargin, 0, Gravity.END | Gravity.TOP);
                break;
            case CENTER:
                setArcLayoutParam(ANIM_MIDDLE_TO_DOWN,
