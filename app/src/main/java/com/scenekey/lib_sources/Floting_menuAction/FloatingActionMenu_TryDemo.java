...
public class FloatingActionMenu_TryDemo extends ViewGroup {
    ...
    public FloatingActionMenu_TryDemo(Context context) {
        this(context, null);
    }

    public FloatingActionMenu_TryDemo(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FloatingActionMenu_TryDemo(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (mIcon == null) {
            mIcon = getResources().getDrawable(R.drawable.add_more1);
        }
    ...
    public void open(final boolean animate) {
        ...
        openKey(animate);
        CustomeClick.getmInctance().onTextChange(null);
    }
    ...
    /**
     * Makes the whole {@link #FloatingActionMenu_TryDemo} to appear and sets its visibility to {@link #VISIBLE}
     *
    ...
    /**
     * Makes the {@link #FloatingActionMenu_TryDemo} to disappear and sets its visibility to {@link #INVISIBLE}
     *
    ...
    /**
     * Makes the {@link FloatingActionButton} to appear inside the {@link #FloatingActionMenu_TryDemo} and
    ...
    /**
     * Makes the {@link FloatingActionButton} to disappear inside the {@link #FloatingActionMenu_TryDemo} and
