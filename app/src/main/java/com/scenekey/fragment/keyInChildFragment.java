...
import com.scenekey.activity.LiveKeyInProfileActivity;
...
public class keyInChildFragment extends Fragment {

    private final String TAG = keyInChildFragment.class.toString();
    public ViewPagerAdapter viewPagerAdapter;
    public VerticalViewPager viewPager;
    private ArrayList<KeyInUserModal> userList;
    private Context context;
    private LiveKeyInProfileActivity activity;
    ...
    private void inItView(View view) {
        ...
        if (bundle.getSerializable("userList") != null) {
            ...
            userList = (ArrayList<KeyInUserModal>) bundle.getSerializable("userList");
            KeyInUserModal keyInUserModal = userList.get(pos);
    ...
    public void onAttach(Context context) {
        ...
        activity = (LiveKeyInProfileActivity) getActivity();
